...
ENVIRONMENT = os.getenv("ENVIRONMENT", "dev" ) # Modificar segun ambiente que se use "dev", "staging"  "prod" en docker-compose
...
_config = SAMPLING_CONFIG.get(ENVIRONMENT, SAMPLING_CONFIG["dev" ])
